...
config <- list(
    ref_gtf = "../../rap-db/2023-11-03/results/gtf/os.rap-db.make.gtf",

    diamond_output = sprintf("results/diamond/%s.rap-db.tsv", variety),
    variety_gtf = sprintf("results/gtf/%s.make.gtf", variety),
    out = sprintf("results/id_converter/%s.rap-db.best-hit.tsv", variety),
